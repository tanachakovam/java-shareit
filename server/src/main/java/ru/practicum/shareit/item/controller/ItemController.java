...
public class ItemController {
    ...
    @PostMapping
    public ItemDto addNewItem(@RequestBody ItemDto itemDto, @RequestHeader(SHARER_USER_ID) int userId) {
    ...
    @GetMapping
    public Collection<ItemDtoFull> getItemsOfUser(@RequestParam(value = "from", defaultValue = "0", required = false) Integer from,
    ...
    public CommentDto addNewComment(@RequestBody CommentDto commentDto, @PathVariable String itemId, @RequestHeader(SHARER_USER_ID) int userId) {
