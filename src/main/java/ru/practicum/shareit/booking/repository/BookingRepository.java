...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    List<Booking> findAllByBookerIdAndStatusEqualsOrderByStartDesc(int id, BookingStatus status, Pageable pageable);
    ...
    @Query(" select b from Booking b " +
            ...
            "and b.status = ?2  " +
            "order by b.start desc ")
    List<Booking> findAllByOwnerAndStatusAndOrderByStartDesc(int id, BookingStatus status, Pageable pageable);
